...
class HikingsS3 extends Component{
    render(){
        return(    
            <Container fluid className="hikings-s3 d-flex minh-50vh align-items-center py-5 border-top border-dark">
