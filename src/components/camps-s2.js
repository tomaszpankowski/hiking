...
class CampsS2 extends Component{
    render(){
        return(    
            <Container fluid className="camps-s2 d-flex minh-50vh bg-white align-items-center py-5 border-top border-dark">
