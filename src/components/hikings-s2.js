...
class HikingsS2 extends Component{
    render(){
        return(    
            <Container fluid className="hikings-s2 d-flex bg-secondary minh-50vh align-items-center py-5 border-top border-dark">
