...
class TipsS3 extends Component{
    render(){
        return(    
            <Container fluid className="tips-s3 d-flex bg-light minh-50vh align-items-center py-5 border-top border-secondary">
