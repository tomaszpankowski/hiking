...
class TipsS2 extends Component{
    render(){
        return(    
            <Container fluid className="tips-s2 d-flex minh-50vh align-items-center py-5 bg-secondary border-top border-secondary">
